...
public class TakeoutFilterFragmentPresenter implements TakeoutFilterFragmentContract.Presenter {
    ...
    private TakeoutFilterFragmentContract.View mView;
    private final TakeoutRepository mOrderRepository;

    @Inject
    TakeoutFilterFragmentPresenter(TakeoutFilterFragmentContract.View view, TakeoutRepository orderRepository) {
        mView = view;
