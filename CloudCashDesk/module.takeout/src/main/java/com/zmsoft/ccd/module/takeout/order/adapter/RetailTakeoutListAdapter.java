...
public class RetailTakeoutListAdapter extends BaseListAdapter {
    ...
    public RetailTakeoutListAdapter(Context context, FooterClick footerClick, @LayoutRes int emptyView, AdapterClick adapterClick) {
    ...
    public BaseHolder onMyCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case TYPE_DELIVERY:
                return new OrderDeliveryHolder(getContext(), inflateLayout(R.layout.module_takeout_item_retail_takeout_delivery, parent), this);
            case TYPE_DESC:
                return new OrderDescHolder(getContext(), inflateLayout(R.layout.module_takeout_item_retail_takeout_desc, parent));
            case TYPE_FOOD:
                return new OrderFoodHolder(getContext(), inflateLayout(R.layout.module_takeout_item_retail_takeout_food, parent));
            case TYPE_PAY_INFO:
                return new OrderPayInfoHolder(getContext(), inflateLayout(R.layout.module_takeout_item_retail_takeout_pay_info, parent));
    ...
    static class OrderMainHolder extends BaseHolder {
        ...
        private RetailTakeoutListAdapter mAdapter;


        OrderMainHolder(Context context, View itemView, RetailTakeoutListAdapter adapter) {
            super(context, itemView);
        ...
        protected void bindView(List source, Object bean) {
            ...
            mTextTakeoutOrderNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mAdapter.mAdapterClick != null) {
                        mAdapter.mAdapterClick.onAdapterClick(RetailTakeoutListAdapter.CLICK_TYPE_CHANGE_STATUS, v, mainHolderVO.getTakeout());
                    }
                }
            });
            ...
            mTextTakeoutOrderPrint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mAdapter.mAdapterClick != null) {
                        mAdapter.mAdapterClick.onAdapterClick(RetailTakeoutListAdapter.CLICK_TYPE_PRINT, v, mainHolderVO.getTakeout());
                    }
                }
            });
                ...
                public void onClick(View v) {
                    if (mAdapter.mAdapterClick != null) {
                        ...
                        if (!TextUtils.isEmpty(takeout.getMobile())) {
                            mAdapter.mAdapterClick.onAdapterClick(RetailTakeoutListAdapter.CLICK_TYPE_SHOW_PHONE_TIP,
                                    v, takeout.getMobile());
                        }
                    }
                }
            ...
            mTextTakeoutOrderRepeal.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mAdapter.mAdapterClick != null) {
                        mAdapter.mAdapterClick.onAdapterClick(RetailTakeoutListAdapter.CLICK_TYPE_CANCEL_ORDER, v, mainHolderVO.getTakeout());
                    }
                }
            });
        }
...
//                                    View.VISIBLE : View.GONE);
    ...
    static class OrderDeliveryHolder extends BaseHolder {
        ...
        @BindView(R2.id.text_takeout_express_code)
        ...
        RetailTakeoutListAdapter mAdapter;

        public OrderDeliveryHolder(Context context, View itemView, RetailTakeoutListAdapter adapter) {
            super(context, itemView);
            mAdapter = adapter;
            ButterKnife.bind(this, itemView);
        }
        ...
        protected void bindView(List source, Object bean) {
            ...
            if (TextUtils.isEmpty(deliveryHolderVO.getExpressCode())) {
                mTextTakeoutExpressCode.setVisibility(View.GONE);

                mTextTakeoutHorseManName.setVisibility(View.VISIBLE);
                mTextTakeoutHorseManTakeTime.setVisibility(View.VISIBLE);
                mTextTakeoutHorseManTakeTime.setText(deliveryHolderVO.getHorseManStatus());
                HorseManTakeTimeOnclick(takeout);
            } else {
                mTextTakeoutHorseManName.setVisibility(View.GONE);
                mTextTakeoutHorseManTakeTime.setVisibility(View.GONE);

                mTextTakeoutExpressCode.setVisibility(View.VISIBLE);
                mTextTakeoutExpressCode.setText(deliveryHolderVO.getExpressCode());
            }
        ...
        private void HorseManTakeTimeOnclick(final Takeout takeout) {
    ...
    static class OrderDescHolder extends BaseHolder {
        ...
        protected void bindView(List source, Object bean) {
            ...
            if (descHolderVO.getPersonNum() != null) {
                mTextTakeoutOrderPersonNum.setVisibility(View.VISIBLE);
                mTextTakeoutOrderPersonNum.setText(descHolderVO.getPersonNum());
            } else {
                mTextTakeoutOrderPersonNum.setVisibility(View.GONE);
            }
    ...
    static class OrderFoodHolder extends BaseHolder {
        ...
        @BindView(R2.id.text_takeout_order_food_bar_code)
        ...
        @BindView(R2.id.text_suite_food_flag_weigh)
        View mTextWeighFlag;
        ...
        protected void bindView(List source, Object bean) {
            ...
            if (TextUtils.isEmpty(foodHolderVO.getCode())) {
                mTextTakeoutOrderFoodBarCode.setText(getString(R.string.module_takeout_retail_no_barcode_label));
            } else {
                mTextTakeoutOrderFoodBarCode.setText(foodHolderVO.getCode());
            }
            if (foodHolderVO.isTwoAccount()) {
                mTextWeighFlag.setVisibility(View.VISIBLE);
            } else {
                mTextWeighFlag.setVisibility(View.GONE);
            }
            ...
            setThroughTextFlag(foodHolderVO.getStatus(), mTextTakeoutOrderFoodBarCode);
