package com.zmsoft.lib.newland.data;
...
import com.zmsoft.lib.newland.bean.NewLandPayDetail;
import com.zmsoft.lib.newland.bean.NewLandResponse;
...
public class NewLandDataHelper {
    ...
    public static boolean isNewLandPay(int payType) {
        if (payType == BusinessHelper.ReceiptMethod.RECEIPT_METHOD_NEW_LAND_ALIPAY
    ...
    public static String getNewLandCancelPayCode(int payType) {
        String code = NewLandConstant.Code.CANCEL_PAY_BANK;
        switch (payType) {
            case BusinessHelper.ReceiptMethod.RECEIPT_METHOD_NEW_LAND_ALIPAY:
            case BusinessHelper.ReceiptMethod.RECEIPT_METHOD_NEW_LAND_WEICHAT:
                ...
                break;
            case BusinessHelper.ReceiptMethod.RECEIPT_METHOD_NEW_LAND_BANK:
                code = NewLandConstant.Code.CANCEL_PAY_BANK;
                break;
        }
        return code;
    }
