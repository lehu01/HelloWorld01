 ...
 * </pre>
 */
public class HangUpOrderListFragment extends BaseListFragment implements HangUpOrderListContract.View {
    ...
    private HangUpOrderListPresenter mPresenter;
    private HangUpOrderListAdapter mAdapter;

    public static HangUpOrderListFragment newInstance() {
        HangUpOrderListFragment fragment = new HangUpOrderListFragment();
        return fragment;
    }
    ...
    public void setPresenter(HangUpOrderListContract.Presenter presenter) {
        mPresenter = (HangUpOrderListPresenter) presenter;
    }
    ...
    private void gotoShopCarActivity(HangUpOrder hangUpOrder) {
        ...
        MRouter.getInstance().build(RouterPathConstant.PATH_CART)
                .putSerializable(RouterPathConstant.Cart.EXTRA_CREATE_ORDER_PARAM, orderParam)
                .putInt(RouterPathConstant.Cart.EXTRA_FROM, RouterPathConstant.Cart.EXTRA_FROM_HANG_UP_ORDER)
                .navigation(getActivity(), HangUpOrderListActivity.RESULT_CART);
    }
}
