...
public class RetailOrderDetailPresenter implements RetailOrderDetailContract.Presenter {
    ...
    @Inject
    public RetailOrderDetailPresenter(RetailOrderDetailContract.View view, OrderDetailSourceRepository orderSourceRepository) {
        mView = view;
    ...
    public void reverseCheckOut(String entityId, String operatorId, String orderId, String reason, long modifyTime) {
        mView.showLoading(GlobalVars.context.getString(R.string.reversing), true);
    ...
    public void afterEndPayForRetail(String entityId, String operatorId, String orderId, long modifyTime) {
        ...
        mView.showLoading(true);
        mReceiptSource.afterEndPayForRetail(entityId, operatorId, orderId, modifyTime, new Callback<AfterEndPay>() {
            @Override
    ...
    @Override
    public void batchUpdateMessage(String messageIdListJson, int status, String resultMsg) {
        mView.showLoading(context.getString(R.string.dialog_handling), true);
        mOrderSourceRepository.batchUpdateMessage(messageIdListJson, status, resultMsg, new Callback<Boolean>() {
            @Override
