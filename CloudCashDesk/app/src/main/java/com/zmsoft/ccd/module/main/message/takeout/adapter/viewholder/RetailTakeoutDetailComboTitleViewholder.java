...
public class RetailTakeoutDetailComboTitleViewholder extends RetailTakeoutDetailBaseViewholder {
    ...
    public RetailTakeoutDetailComboTitleViewholder(Context context, View itemView, RecyclerView recyclerView
