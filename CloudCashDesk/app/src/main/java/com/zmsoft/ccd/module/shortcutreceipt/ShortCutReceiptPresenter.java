...
public class ShortCutReceiptPresenter implements ShortCutReceiptContract.Presenter {
    ...
    private ShortCutReceiptContract.View mView;
    private final ShortCutReceiptRepository mShortCutReceiptRepository;

    @Inject
    ShortCutReceiptPresenter(ShortCutReceiptContract.View view, ShortCutReceiptRepository shortCutReceiptRepository) {
        this.mView = view;
