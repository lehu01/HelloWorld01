...
public class OrderDetailBaseViewHolder extends BaseHolder {
    ...
    public OrderDetailBaseViewHolder(Context context, View itemView, RecyclerView.Adapter adapter) {
        super(context, itemView);
        if (null != adapter && adapter instanceof OrderDetailAdapter) {
            orderDetailAdapter = (OrderDetailAdapter) adapter;
        }
