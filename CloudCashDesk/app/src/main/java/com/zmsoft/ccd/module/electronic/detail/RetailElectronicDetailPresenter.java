...
public class RetailElectronicDetailPresenter implements RetailElectronicDetailContract.Presenter {
    ...
    @Inject
    public RetailElectronicDetailPresenter(RetailElectronicDetailContract.View view, ElectronicRepository electronicRepository) {
        this.mView = view;
    ...
    public void getElePaymentDetail(String payId) {
        mElectronicRepository.getElePaymentDetail(payId, new Callback<GetElePaymentResponse>() {
            @Override
