...
public class RetailTakeoutMsgDetailOrderViewHolder extends RetailTakeoutDetailBaseViewholder {
    ...
    public RetailTakeoutMsgDetailOrderViewHolder(Context context, View itemView, RecyclerView recyclerView
    ...
    protected void initInfoView(int position) {
        ...
        switch (mOrderInfo.getReserveStatus()) {
            ...
            case TakeoutConstants.ReserveStatus.APPOINTMENT:
                ...
                mTextTakeoutOrderAppointmentFlag.setText(R.string.retail_takeout_msg_pay_detail_subscribe);
                break;
            default:
                mTextTakeoutOrderAppointmentFlag.setVisibility(View.GONE);
                break;
        ...
        if (mOrderInfo.getSendType() == TakeoutConstants.SendType.SELF_TAKE) {
            mTextTakeoutOrderPersonLabel.setText(context.getString(R.string.retail_takeout_msg_pay_detail_receiver));
            mLayoutAddress.setVisibility(View.GONE);
        } else {
            mTextTakeoutOrderPersonLabel.setText(context.getString(R.string.takeout_msg_pay_detail_receiver));
        ...
        if (!TextUtils.isEmpty(mOrderInfo.getReceiverName()) || !TextUtils.isEmpty(mOrderInfo.getReceiverPhone())) {
            mTextTakeoutOrderPersonLabel.setVisibility(View.VISIBLE);
            ...
            mTextTakeoutOrderPersonLabel.setVisibility(View.GONE);
        }
        ...
        mTextPeopleCount.setText(String.format(mContext.getString(R.string.retail_takeout_people_count)
