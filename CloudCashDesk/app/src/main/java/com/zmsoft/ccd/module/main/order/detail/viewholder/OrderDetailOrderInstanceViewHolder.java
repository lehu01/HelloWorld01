 ...
 */
public class OrderDetailOrderInstanceViewHolder extends OrderDetailBaseViewHolder {
    ...
    public OrderDetailOrderInstanceViewHolder(Context context, View itemView, RecyclerView.Adapter adapter) {
        ...
        if (instance != null) {
            ...
            if (isReject) {
                mTextInstancePrice.setText(SpannableStringUtils.getBuilder(getContext()
                        , String.format(getContext().getString(R.string.yuan_format)
                                , FeeHelper.jointMoneyWithCurrencySymbol(UserHelper.getCurrencySymbol()
                                        , FeeHelper.getDecimalFee(instance.getFee()))))
                        .setStrikethrough()
                        .create());
            } else {
                mTextInstancePrice.setText(String.format(getContext().getString(R.string.yuan_format)
                        , FeeHelper.jointMoneyWithCurrencySymbol(UserHelper.getCurrencySymbol()
                                , FeeHelper.getDecimalFee(instance.getFee()))));
            }
