...
public class DeskMsgServiceCallViewholder extends BaseDeskMsgViewholder {
    public DeskMsgServiceCallViewholder(Context context, View itemView, RecyclerView.Adapter adapter) {
    ...
    protected void initInfoView(int position) {
        ...
        mTvTime.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.icon_message_ring, 0, 0);
    }
