...
public class RetailShortCutReceiptFragment extends BaseFragment implements RetailShortCutReceiptContract.View, CustomSoftKeyboardView.OnKeyboardClickListener {
    ...
    public static RetailShortCutReceiptFragment newInstance() {
        ...
        RetailShortCutReceiptFragment fragment = new RetailShortCutReceiptFragment();
