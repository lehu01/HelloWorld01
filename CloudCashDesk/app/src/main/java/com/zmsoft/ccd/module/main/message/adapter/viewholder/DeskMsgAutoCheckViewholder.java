...
public class DeskMsgAutoCheckViewholder extends BaseDeskMsgViewholder {

    public DeskMsgAutoCheckViewholder(Context context, View itemView, RecyclerView.Adapter adapter) {
