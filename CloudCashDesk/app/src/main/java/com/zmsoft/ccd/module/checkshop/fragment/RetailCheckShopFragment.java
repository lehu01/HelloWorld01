...
import com.zmsoft.ccd.module.checkshop.adapter.RetailCheckShopAdapter;
...
public class RetailCheckShopFragment  extends BaseListFragment implements RetailCheckShopContract.View {
    ...
    public static RetailCheckShopFragment newInstance(int from) {
        RetailCheckShopFragment fragment = new RetailCheckShopFragment();
        Bundle bundle = new Bundle();
        bundle.putInt(RouterPathConstant.RetailCheckShop.FROM, from);
    ...
    protected BaseListAdapter createAdapter() {
        mShopAdapter = new RetailCheckShopAdapter(getActivity(), null);
        return mShopAdapter;
    }
...
//        }
    ...
    public void setPresenter(RetailCheckShopContract.Presenter presenter) {
        mCheckShopPresenter = (RetailCheckShopPresenter) presenter;
    }
    ...
    private void notifyRefreshByAll() {
        switch (mFrom) {
            case RouterPathConstant.RetailCheckShop.FROM_LOGIN:
                gotoMainActivity();
                break;
            case RouterPathConstant.RetailCheckShop.FROM_MAIN:
