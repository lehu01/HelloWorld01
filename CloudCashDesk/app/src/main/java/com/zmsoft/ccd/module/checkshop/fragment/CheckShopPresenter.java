...
public class CheckShopPresenter implements CheckShopContract.Presenter {
    ...
    private CheckShopContract.View mCheckShopView;
    private final CheckShopRepository mCheckShopRepository;
    private final UserDataSource mUserRemoteSource;

    @Inject
    public CheckShopPresenter(CheckShopContract.View view, CheckShopRepository checkShopRepository) {
        mCheckShopView = view;
    ...
    @Override
    public void bindShop(BindShopRequest request) {
//        mCheckShopRepository.bindShop(request, new Callback<CompositeLoginResultVo>() {
//            @Override
//            public void onSuccess(CompositeLoginResultVo data) {
//                if (mCheckShopView == null) {
//                    return;
//                }
//                User user = TLoginDataManager.getUser(data);
//                if (user != null) {
//                    mCheckShopView.bindShop(user);
//                } else {
...
//        });
    ...
    public void bindShop(String memberId, String userId, String entityId, String originalUserId) {
        mCheckShopRepository.bindShop(memberId, userId, entityId, originalUserId, new com.zmsoft.ccd.data.Callback<User>() {
            @Override
