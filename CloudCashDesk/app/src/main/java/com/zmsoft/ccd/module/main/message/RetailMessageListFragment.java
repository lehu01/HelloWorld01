...
import com.zmsoft.ccd.module.main.message.dagger.DaggerRetailMsgCenterComponent;
import com.zmsoft.ccd.module.main.message.dagger.RetailMsgCenterPresenterModule;
 ...
 * @time : 2016/12/16 15:30
 */
public class RetailMessageListFragment extends BaseListFragment implements RetailMessageListContract.View {
    ...
    public static RetailMessageListFragment newInstance() {
        ...
        RetailMessageListFragment fragment = new RetailMessageListFragment();
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        DaggerRetailMsgCenterComponent.builder()
                .messageComponent(DaggerMessageComponent.builder()
                        .appComponent(CcdApplication.getInstance().getAppComponent())
                        .build())
                .retailMsgCenterPresenterModule(new RetailMsgCenterPresenterModule(this))
                .build()
                .inject(this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        MRouter.getInstance().build(RetailMsgSettingActivity.PATH_MSG_SETTING).navigation(this);
    ...
    public void changeMsgList(FilterItem filterItem) {
        if (filterItem != null) {
            ...
            if (code.equals(FilterItem.MENU_ITEM_MESSAGE_USER)) { //顾客新消息
                mMsgCategory = MessageHelper.MsgCategory.MESSAGE_NEW;
                refreshMsgTitle();
        ...
        if (UserHelper.getWorkStatus()) {
            ...
            if (null != batchHandleMsgList) {
                if (mPresenter.isNeedBatchUpdateMsg(getAdapter().getList(), position)) {
                    getDialogUtil().showDialog(R.string.material_dialog_title, String.format(getString(R.string.retail_msg_msgcenter_result_all_handled_hint)
