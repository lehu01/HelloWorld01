...
public class TakeoutDetailBaseViewholder extends BaseRecyclerHolder<TakeoutDetailRecyclerItem> {
    ...
    protected TakeoutDetailAdapter mRecyclerItemAdapter;
    protected View mItemView;
    protected TakeoutDetailRecyclerItem mDeskMsgDetailRecyclerItem;
    protected int mItemType;

    public TakeoutDetailBaseViewholder(Context context, View itemView, RecyclerView recyclerView
            , RecyclerView.Adapter adapter) {
        super(context, itemView, adapter);
        this.mContext = context;
        if (null != adapter && adapter instanceof TakeoutDetailAdapter)
            mRecyclerItemAdapter = (TakeoutDetailAdapter) adapter;
