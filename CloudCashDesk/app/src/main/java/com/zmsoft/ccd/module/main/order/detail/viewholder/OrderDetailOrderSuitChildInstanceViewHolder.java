 ...
 */
public class OrderDetailOrderSuitChildInstanceViewHolder extends OrderDetailBaseViewHolder {
    ...
    public OrderDetailOrderSuitChildInstanceViewHolder(Context context, View itemView, RecyclerView.Adapter adapter) {
