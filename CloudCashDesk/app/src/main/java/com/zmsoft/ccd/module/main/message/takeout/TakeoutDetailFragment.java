...
public class TakeoutDetailFragment extends BaseFragment implements TakeoutDetailContract.View {
    ...
    private TakeoutDetailPresenter mPresenter;
    private TakeoutDetailAdapter mRecyclerAdapter;
    ...
    public static TakeoutDetailFragment newInstance(int position, String msgId, String orderId, int msgType) {
        TakeoutDetailFragment fragment = new TakeoutDetailFragment();
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        mRecyclerAdapter = new TakeoutDetailAdapter(getActivity(), mRecyclerviewMsgDetail, mDatas);
    ...
    public void setPresenter(TakeoutDetailContract.Presenter presenter) {
        this.mPresenter = (TakeoutDetailPresenter) presenter;
    }
    ...
    public void successGetMsgDetail(TakeoutMsgDetailResponse takeoutMsgDetailResponse) {
        ...
        mDatas.addAll(DataMapLayer.getTakeoutDetailRecyclerItemList(takeoutMsgDetailResponse));
