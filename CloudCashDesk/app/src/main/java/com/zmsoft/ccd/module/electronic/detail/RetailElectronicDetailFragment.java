...
public class RetailElectronicDetailFragment extends BaseFragment implements RetailElectronicDetailContract.View {
    ...
    public static RetailElectronicDetailFragment newInstance(String payId, String code) {
        ...
        RetailElectronicDetailFragment fragment = new RetailElectronicDetailFragment();
    ...
    protected int getLayoutId() {
        return R.layout.retail_electronic_detail_fragment_layout;
    }
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        if (!BatchPermissionHelper.getPermission(Permission.ClearPay.ACTION_CODE)) {
                            showToast(context.getString(R.string.permission_clear_pay));
                            return;
                        }
