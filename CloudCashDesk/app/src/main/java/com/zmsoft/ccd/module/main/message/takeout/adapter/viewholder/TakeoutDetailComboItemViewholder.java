...
public class TakeoutDetailComboItemViewholder extends TakeoutDetailBaseViewholder {
    ...
    public TakeoutDetailComboItemViewholder(Context context, View itemView, RecyclerView recyclerView, RecyclerView.Adapter adapter) {
