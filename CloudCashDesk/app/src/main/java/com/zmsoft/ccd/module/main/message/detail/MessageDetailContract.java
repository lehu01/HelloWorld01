...
public interface MessageDetailContract {
    ...
    interface Presenter extends BasePresenter {
        void loadMsgDetail(List<DeskMsgDetailRecyclerItem> datas, String messageId);

        void handleMessage(String messageId, DeskMsgDetail deskMsgDetail, int position, boolean isAgree);
         ...
         */
        void refreshMessage(DeskMsgDetail deskMsgDetail, int position, boolean isAgree, String messageId);
    }
}
