 ...
 */
public class OrderDetailOrderPayInfoViewHolder extends OrderDetailBaseViewHolder {
    ...
    public OrderDetailOrderPayInfoViewHolder(Context context, View itemView, RecyclerView.Adapter adapter) {
