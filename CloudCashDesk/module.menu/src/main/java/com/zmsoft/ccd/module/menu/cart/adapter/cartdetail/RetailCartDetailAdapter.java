...
import com.zmsoft.ccd.module.menu.cart.adapter.cartdetail.viewholder.RetailCartDetailRemarkItemViewHolder;
...
public class RetailCartDetailAdapter extends BaseListAdapter {
    private Context mContext;

    public RetailCartDetailAdapter(Context context, FooterClick footerClick) {
    ...
    public BaseHolder onMyCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case CartDetailRecyclerItem.ItemType.TYPE_REMARK:
                return new RetailCartDetailRemarkItemViewHolder(mContext
                        , inflateLayout(R.layout.module_menu_item_retail_recyclerview_cartdetail_remark, parent));
            default:
