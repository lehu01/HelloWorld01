...
public class CustomFoodActivity extends BaseActivity {
    ...
    private CustomFoodFragment mFoodFragment;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.module_menu_activity_custom_food);

        mCreateOrderParam = (OrderParam) getIntent()
                .getSerializableExtra(RouterPathConstant.CustomFood.EXTRA_CREATE_ORDER_PARAM);
        ItemVo mItemVO = (ItemVo) getIntent().getSerializableExtra(RouterPathConstant.CustomFood.EXTRA_CUSTOM_FOOD_ITEMVO);

        mFoodFragment = new CustomFoodFragment();
        if (mItemVO != null) {
            Bundle bundle = new Bundle();
            bundle.putSerializable(RouterPathConstant.CustomFood.EXTRA_CUSTOM_FOOD_ITEMVO, mItemVO);
