...
public class RetailCartDetailPresenter implements RetailCartDetailContract.Presenter {
    ...
    @Inject
    public RetailCartDetailPresenter(RetailCartDetailContract.View view, CartRepository repository) {
        mView = view;
...
//        mView.showLoading(GlobalVars.context.getString(R.string.dialog_waiting), false);
    ...
    private List<CartItem> getCartItems(String menuId, List<CartDetailRecyclerItem> cartRecyclerItems
        ...
        if (null != normalMenuVo.getMenu()) {
            ...
            mCartItem.setAccountNum(normalMenuVo.getMenu().getAccountNum());
