...
import com.zmsoft.ccd.module.menu.cart.presenter.cartdetail.RetailCartDetailPresenter;
import com.zmsoft.ccd.module.menu.cart.presenter.cartdetail.dagger.DaggerRetailCartDetailComponent;
import com.zmsoft.ccd.module.menu.cart.presenter.cartdetail.dagger.RetailCartDetailPresenterModule;
 ...
 * @create 2017/4/18.
 */
@Route(path = RouterPathConstant.RetailCartDetail.PATH_CART_DETAIL)
public class RetailCartDetailActivity extends ToolBarActivity {
    /**
     * 商品详情页分类
     *
    ...
    @Inject
    RetailCartDetailPresenter mPresenter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_framelayout);
        RetailCartDetailFragment cartDetailFragment = (RetailCartDetailFragment) getSupportFragmentManager()
        ...
        if (cartDetailFragment == null) {
            cartDetailFragment = RetailCartDetailFragment.newInstance(mMenuId, mDetailType, mItemVo, mSeatCode
        ...
        DaggerRetailCartDetailComponent.builder()
                .cartSourceComponent(ComponentManager.get().getCartSourceComponent())
                .retailCartDetailPresenterModule(new RetailCartDetailPresenterModule(cartDetailFragment))
                .build()
                .inject(this);
    }
}
