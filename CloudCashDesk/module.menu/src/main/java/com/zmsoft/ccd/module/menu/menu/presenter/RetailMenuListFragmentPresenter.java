...
public class RetailMenuListFragmentPresenter implements RetailMenuListFragmentContract.Presenter {
    ...
    private RetailMenuListFragmentContract.View mView;
    private ICartSource mCartRepository;

    @Inject
    RetailMenuListFragmentPresenter(RetailMenuListFragmentContract.View view, MenuRepository menuRepository) {
        this.mView = view;
