 ...
 * @create 2017/4/20.
 */
public class CardDetailDataMapLayer extends BaseDataHelper {
            ...
            if (null != specDataList && !specDataList.isEmpty()) {
                ...
                for (int i = 0; i < specDataList.size(); i++) {
                    ...
                    if (specDataDto.getPriceScale() > 0) {
                        ...
                        addPrice = FeeHelper.jointMoneyWithCurrencySymbol(UserHelper.getCurrencySymbol(), addPrice);
                    }
                        ...
                        if (null != additionMenuList && !additionMenuList.isEmpty()) {
                            for (int j = 0; j < additionMenuList.size(); j++) {
                                ...
                                if (price > 0) {
                                    ...
                                    feedPrice = FeeHelper.jointMoneyWithCurrencySymbol(UserHelper.getCurrencySymbol(), feedPrice);
                                }
