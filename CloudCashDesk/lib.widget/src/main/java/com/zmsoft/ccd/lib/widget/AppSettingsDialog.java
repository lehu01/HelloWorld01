...
public class AppSettingsDialog implements Parcelable, DialogInterface.OnClickListener {
    ...
    // 进入系统设置页面后的hook
    public interface AfterGotoAppSettingsHook {
        void afterGotoAppSetting();
    }
    ...
    private AfterGotoAppSettingsHook mAfterGotoAppSettingsHook;
    ...
    private AppSettingsDialog(@NonNull final Object activityOrFragment,
                              ...
                              @Nullable AfterGotoAppSettingsHook afterGotoAppSettingsHook,
                              int requestCode) {
        ...
        mAfterGotoAppSettingsHook = afterGotoAppSettingsHook;
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        /*
         * 部分手机：例如华为手机
         * 先onPause再onResume（立马触发跳转），再进入系统设置页面
         * 所以这里加延时，在系统设置页面返回后，再触发onResume
         */
        Observable.timer(100, TimeUnit.MILLISECONDS)
                ...
                .subscribe(new Subscriber<Long>() {
                    ...
                    public void onCompleted() {
                        if (mAfterGotoAppSettingsHook != null) {
                            mAfterGotoAppSettingsHook.afterGotoAppSetting();
                        }
                    }
    ...
    private void gotoMiuiPermission() {
        ...
        i.putExtra("extra_pkgname", mContext.getApplicationContext().getPackageName());
        try {
            startForResult(i);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void gotoDefaultSetting() {
    ...
    public static class Builder {
         ...
         * hasPermissions(Context, String...) in {@link
        ...
        public Builder setAfterGotoAppSettingsHook(AfterGotoAppSettingsHook afterGotoAppSettingsHook) {
            this.mAfterGotoAppSettingsHook = afterGotoAppSettingsHook;
            return this;
        }
