...
public class LinearLayoutCouponView extends LinearLayout {

    private CouponViewHelper helper;

    public LinearLayoutCouponView(Context context) {
        this(context, null);
    }

    public LinearLayoutCouponView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearLayoutCouponView(Context context, AttributeSet attrs, int defStyle) {
