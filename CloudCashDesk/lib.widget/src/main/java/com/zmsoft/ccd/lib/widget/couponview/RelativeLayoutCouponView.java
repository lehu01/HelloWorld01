package com.zmsoft.ccd.lib.widget.couponview;
...
public class RelativeLayoutCouponView extends RelativeLayout {

    private CouponViewHelper helper;

    public RelativeLayoutCouponView(Context context) {
        this(context, null);
    }

    public RelativeLayoutCouponView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RelativeLayoutCouponView(Context context, AttributeSet attrs, int defStyle) {
